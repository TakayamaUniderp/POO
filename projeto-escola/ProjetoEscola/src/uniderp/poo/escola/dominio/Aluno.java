...
public class Aluno extends BasePF implements IImpressao {
    ...
    public Aluno(int id, LocalDate dataInsercao, String endereco, String telefone, String nome, String rg,
